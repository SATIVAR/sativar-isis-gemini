...
export const ProductModal: React.FC<{
    ...
    return (
        <Modal
            ...
            onClose={onClose}
            size="lg"
            icon={<PackageIcon className="w-6 h-6 text-fuchsia-400" />}
            footer={
                <>
                    ...
                    <button type="submit" form="product-form" className="px-5 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 transition-colors">Salvar Produto</button>
                </>
            }
        >
